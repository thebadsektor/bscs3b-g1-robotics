...
/*
  Uses the following:
  3 Line Tracking Sensor Modules
*/
...
/*
  Uses the following:
  Bluetooth Module
  LAFVIN 4WD Smart Robot Car BLE V2 2 (Android Application)
*/
...
/*
  Uses the following:
  2 Photoresistive Sensor Module
*/
void Light_Seeking() {
  Funtion_FLag = true;
  while (Funtion_FLag) {
...
/*
  Uses the following:
  IR Receiver on the Motor Drive Expansion Board
  IR Remote
*/
void Infraed_Remote() {
  Funtion_FLag = true;
